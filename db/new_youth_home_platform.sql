...
--
-- Host: localhost    Database: new_youth_home_platform
-- ------------------------------------------------------
...
--
-- Current Database: `new_youth_home_platform`
--

/*!40000 DROP DATABASE IF EXISTS `new_youth_home_platform`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `new_youth_home_platform` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `new_youth_home_platform`;
